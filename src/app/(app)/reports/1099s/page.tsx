...
export default async function Reports1099SPage() {
  ...
  const canGenerate = organization.plan === Plan.PROFESSIONAL || organization.plan === Plan.ENTERPRISE;
  return <Reports1099SClient initialRows={rows} initialYear={year} canGenerate={canGenerate} />;
}
